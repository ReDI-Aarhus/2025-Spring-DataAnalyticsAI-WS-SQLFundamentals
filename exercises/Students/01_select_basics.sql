...
--=======================================
-- Your query here
SELECT FirstName, LastName, FirstName+''+LastName AS 'FullName', EmailAddress
...
--=======================================
-- Your query here
SELECT ProductID, p.name AS ProductName, ListPrice
...
--=======================================
-- Your query here
SELECT TOP 10 ProductID, p.Name AS ProductName, ListPrice
FROM SalesLT.Product AS p
